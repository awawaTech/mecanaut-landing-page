...
const faqItems: FaqItem[] = [
  {
    question: '¿Qué es Macanaut y cómo me ayuda?',
    answer:
      'Macanaut es un software que organiza y automatiza el mantenimiento de tu maquinaria. Evita olvidos, reduce fallas y mejora el control de tu operación.',
  },
  {
